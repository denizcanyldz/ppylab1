...
Original file is located at
    https://colab.research.google.com/drive/1_TcFQq146KtyF3aPzJPoLbgMUo51AETB
...
age = input("Could you please share your age with us? ")
...
# Get the first number as an integer
first_number = int(input("Enter the first number: "))

# Get the second number as an integer
second_number = int(input("Enter the second number: "))

# Check if the first number is divisible by the second
divisible = first_number % second_number == 0
...
print(first_number,result ,"with",second_number)
...
if side1 + side2 > side3 and side1 + side3 > side2 and side2 + side3 > side1:
    print("Triangle can be drawn with the given sides.")
else:
     print("Triangle cannot be drawn with the given sides.")
...
if operation == "+":
    ...
    if num2 == 0:
        result = num1,"can not be divided by zero"
    else:
        result = num1 / num2
else:
    result = "Invalid operation"
